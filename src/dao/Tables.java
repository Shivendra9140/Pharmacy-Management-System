...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','16-12-2023','1234567890','admin@email.com','admin','admin','India')");
